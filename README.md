...
GrowOS 是一个面向黑客松展示的“企业资源自动发现与行动系统”。它把传统的企业主动搜索政策、园区、伙伴和人才，改造成 BP / 官网 / 团队描述输入后的自动画像、自动匹配和自动行动规划。

## Demo 能力

- 企业输入：支持公司名、官网链接、团队 / BP 摘要和 BP 文件上传。
- 企业画像：自动识别行业标签、技术标签、企业阶段、技术壁垒和阶段性短板。
- 四向匹配：基于模拟中关村公共服务资源库，匹配政策、园区、企业伙伴和人才画像。
...
GrowOS 的核心价值不是“查政策”，而是先理解企业，再把政策、园区、产业伙伴和关键人才组织成一条可执行的成长路径。Demo 中用户输入一段 BP 摘要后，系统会完成从 `Search` 到 `Match & Action` 的闭环展示。
